...
- [x] The project includes a one-to-one database relationship (one user -> one account)
...
What went well during this unit was that we were able to get the project deployed and make more of the app feel complete. We improved the frontend, added better product images, and made important user flows work more smoothly, especially the cart and checkout experience. By the end, the app felt much more like a real full-stack project.

### 2. What were some challenges your group faced in this unit?

One of the biggest challenges was coordination. Some work depended on different teammates, and at times it was hard to know what branch had the latest version, what was fully finished, and what still needed to be connected. We also ran into deployment and database access issues, which made testing and final integration more difficult than expected.

### 3. What were some of the highlights or achievements that you are most proud of in this project?

One of the highlights I am most proud of is that we were able to take the project from a basic idea and turn it into a working deployed app with both frontend and backend pieces. I am also proud that we improved the visual side of the app by adding real product images and made the shopping flow stronger with cart and checkout functionality.

### 4. Reflecting on your web development journey so far, how have you grown since the beginning of the course?

Since the beginning of the course, I have grown a lot in understanding how frontend and backend pieces connect in a full-stack app. I feel more comfortable working with React, Express, routing, APIs, deployment, and debugging. I also learned more about working in a team project, handling branches, merging code, and solving issues under time pressure.

### 5. Looking ahead, what are your goals related to web development, and what steps do you plan to take to achieve them?

Going forward, I want to keep improving my full-stack development skills and get more comfortable building complete projects from start to finish. I also want to get better at backend integration, deployment, and writing cleaner, more maintainable code. To do that, I plan to keep building projects, practicing with real-world app features, and continuing to strengthen both my frontend and backend knowledge.